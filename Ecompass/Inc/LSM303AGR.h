...
HAL_StatusTypeDef LSM303AGR_readRegister(uint8_t LSM303AGR_reg, uint8_t* LSM303AGR_data,
		uint8_t ACC_MAG);
HAL_StatusTypeDef LSM303AGR_writeRegister(uint8_t LSM303AGR_reg, uint8_t* LSM303AGR_data,
		uint8_t ACC_MAG);
void LSM303AGR_init();
